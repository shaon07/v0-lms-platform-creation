...
export default function PlaylistClient({ course, playlistId, initialVideos, debugError }: PlaylistClientProps) {
        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-1 max-w-[1600px] mx-auto w-full p-4 md:p-6">
                ...
                <div className="mb-4 p-2 bg-muted text-xs font-mono rounded border">
                    ...
                    {debugError && <p className="text-red-500">Scraper Error: {debugError}</p>}
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold mb-2">
                                {videos[activeLessonIndex]?.title || `Lesson ${activeLessonIndex + 1}`}
                            </h2>
                                ...
                                <div className="p-2 space-y-1">
                                    {videos.map((video, index) => (
                                        <button
                                            ...
                                            className={`w-full text-left p-3 rounded-lg text-sm transition-colors flex gap-3 group ${index === activeLessonIndex
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className={`font-medium truncate ${index === activeLessonIndex ? "text-primary" : "text-foreground"
                                                    }`}>
                                                    {video.title}
                                                </p>
