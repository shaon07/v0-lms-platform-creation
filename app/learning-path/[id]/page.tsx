    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mb-6">{path.description}</p>
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-muted-foreground">Skills You'll Learn</p>
        ...
        <Card className="bg-muted/30 border-primary/20 mb-12">
          ...
          <CardContent className="space-y-3 text-sm">
            <p>
              This structured learning path guides you through the most essential concepts and practical skills in a
              logical order, ensuring you build a strong foundation before moving to advanced topics.
            </p>
            <ul className="space-y-2 list-disc list-inside text-muted-foreground">
              <li>Sequential learning from fundamentals to advanced concepts</li>
              ...
              <li>Industry-recognized skills taught by experienced instructors</li>
            </ul>
          </CardContent>
        </Card>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mb-6">Begin with the first course and progress at your own pace</p>
          <Button size="lg" asChild>
            <Link href={`/course/${pathCourses[0]?.id}`}>Start Learning Now</Link>
          </Button>
        </div>
      </main>
    </div>
