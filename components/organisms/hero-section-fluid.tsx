...
export default function HeroSectionFluid(_props: Props) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 py-16 md:py-24">
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        <div className="absolute top-0 right-0 w-80 h-80 md:w-[36rem] md:h-[36rem] bg-accent/20 rounded-full blur-3xl -translate-y-8 md:-translate-y-12" />
        <div className="absolute bottom-0 left-0 w-72 h-72 md:w-[32rem] md:h-[32rem] bg-primary/20 rounded-full blur-3xl -translate-x-8 md:-translate-x-12" />
      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              onClick={() => {
                ...
                else window.location.href = "/#learning-paths-section";
              }}
            >
